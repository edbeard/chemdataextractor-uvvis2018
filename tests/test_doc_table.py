...
class TestTable(unittest.TestCase):
    ...
    def test_spectroscopic_table(self):
        ...
        gold = [
            {'names': ['Coumarin 343'], 'quantum_yields': [{'type': '\u03d5', 'solvent': 'acetonitrile', 'value': '0.52', 'temperature': '298', 'temperature_units': 'K'}], 'uvvis_spectra': [{'temperature': '298', 'temperature_units': 'K', 'solvent': 'acetonitrile', 'peaks': [{'units': 'nm', 'value': '398', 'extinction': '40800', 'extinction_units': 'M \u2013 1 cm \u2013 1'}]}]},
            {'labels': ['C144'], 'uvvis_spectra': [{'temperature': '298', 'temperature_units': 'K', 'solvent': 'acetonitrile', 'peaks': [{'units': 'nm', 'value': '429', 'extinction': '9500', 'extinction_units': 'M \u2013 1 cm \u2013 1'}]}]},
